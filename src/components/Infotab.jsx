...
export function Infotab() {
    ...
    return (
        <div className='grid grid-cols-1 md:flex justify-center h-fit m-4 mt-14'>
            <div className='flex pb-10 md:pb-0'>
                <div className='p-4 pt-0 md:p-8 relative'>
                    ...
                    <CountUp
                        ...
                        {({ countUpRef }) => (
                            <div>
                                <span className="text-7xl md:text-9xl drop-shadow-lg font-bold text-blue-400 h-24 flex items-center justify-center" ref={countUpRef} />
                            </div>
                        )}
                    </CountUp>
                </div>
            ...
            <div className='flex justify-center items-center md:hidden pb-10'>
                <a href='#form'>
                    <button className="bg-blue-400 text-white p-2 rounded-md mt-6 md:ml-8">
                        <div>Get In Touch</div>
                    </button>
